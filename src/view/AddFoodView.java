 ...
 */
public class AddFoodView extends GridPane {
  /**
  ...
  public AddFoodView () {
    ...
    submit = new Button ("Create Food");
    submit.addEventHandler(MouseEvent.MOUSE_CLICKED, new NewFoodHandler ());
  ...
  // event handler
  class NewFoodHandler implements EventHandler <Event> {
    @Override
    public void handle(Event event) {
      if (!Main.food.has (name_input.getText ())) {
